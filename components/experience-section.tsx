        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          <div className="text-white pt-0 md:pt-12 md:sticky md:top-12 self-start">
            <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-6 md:mb-8 leading-[1.3]">
              My journey<span className="bg-[#6366F1] dark:bg-indigo-900 text-white px-3 py-1 inline-block">building products</span>
            </h2>
            ...
            <Link href="/Resume_Suraj_Kumar.pdf" target="_blank" rel="noopener noreferrer">
              <Button className="bg-white dark:bg-gray-800 text-black dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg py-5 px-8 md:py-[22px] md:px-[62px] text-base md:text-lg font-semibold h-auto w-full sm:w-auto sm:min-w-[240px]">
