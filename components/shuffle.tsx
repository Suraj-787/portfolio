...
// Custom SplitText implementation (since SplitText is a premium plugin)
class SplitText {
  chars: HTMLElement[] = [];
  private originalElement: HTMLElement;
  
  constructor(element: HTMLElement, options: { type: string; charsClass: string; wordsClass: string; linesClass: string; smartWrap: boolean; reduceWhiteSpace: boolean }) {
  ...
  revert() {
    const text = this.chars.map(c => c.textContent).join('');
    this.originalElement.textContent = text;
    this.chars = [];
  }
}
